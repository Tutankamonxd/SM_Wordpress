...
?>
<?php
  $food_grocery_hub_content = apply_filters( 'the_content', get_the_content() );
  $audio = false;

  // Only get audio from the content if a playlist isn't present.
  if ( false === strpos( $food_grocery_hub_content, 'wp-playlist-script' ) ) {
    $audio = get_media_embedded_in_content( $food_grocery_hub_content, array( 'audio' ) );
  }
?>
